...
#define SUBJECTS 3
class Student{
    static int Count;             // Count number of objects
    static char SchoolName[20];   // School Name 
    int ID;
    char *Name;
...
public:
    ...
    static void SetSchoolName(const char *name){strcpy(SchoolName, name);}
...
/* Initialize static variable of class Student */
int Student::Count = 0;
char Student::SchoolName[20] = "\0";
...
int main(){
    ...
    cout << "Number of objects: " << Student::GetCount() << endl;
    Student::SetSchoolName("ITI");
